...
def userarguments():
    ...
    # folders names
    parser.add_argument("--path_input", default="/media/ben/Data_linux/code/unsupervised_learning/dataset/Image_input/", type=str,
...
def training(model, iterations, lr, stepsize_con, stepsize_sim, size, nConv, nChannel, cwd):
    ...
    if WRITE:
        ...
        cv2.imwrite(PATH_OUTPUT + filename_output, im_target_rgb)
