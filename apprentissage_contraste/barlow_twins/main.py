...
CHECKPOINT_PATH = os.environ.get("PATH_CHECKPOINT", "saved_models/Barlow_twins/")
...
def train_barlow(lr, weight_decay, max_epochs, train_loader_us, val_loader_us):
    ...
    trainer = pl.Trainer(default_root_dir=os.path.join(CHECKPOINT_PATH, "Barlow"),
...
def loading_model(arch=ARCH):
    ...
    path_model_res18 = Path('/home/lepersbe/Narval/Barlow_twins_pytorch_lightning/saved_models/Barlow_twins/Barlow/lightning_logs/version_3/checkpoints/')

    str_res50 = 'epoch=7-step=247.ckpt'
    #str_res18 = 'epoch=6-step=216.ckpt'
    str_res18 = 'epoch=2-step=38.ckpt'
...
def load_logistic():
    ...
    path_model = Path('/home/lepersbe/Narval/Barlow_twins_pytorch_lightning/saved_models/Barlow_twins/LogisticRegression/lightning_logs/version_5/checkpoints/')
    path_model_best = path_model/'epoch=0-step=135.ckpt'
