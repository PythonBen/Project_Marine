...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 17 10:28:13 2021
...
unlabeled_data_train = datasets_submeeting.unlabeled_data_train
unlabeled_data_val  = datasets_submeeting.unlabeled_data_val
...
class Barlow(pl.LightningModule):
    def __init__(self,lr, weight_decay, max_epochs=EPOCHS_US, lambd=0.0051, arch=ARCH):
        super().__init__()
...
def loading_model(arch=ARCH):
    ...
    #path_model = Path('/home/lepersbe/Narval/Barlow_twins_pytorch_lightning/saved_models/Barlow_twins/Barlow/lightning_logs/version_1/checkpoints/')
    #path_model_res50 = Path('/home/lepersbe/Narval/Barlow_twins_pytorch_lightning/saved_models/Barlow_twins/Barlow/resnet50_im128x128_bs128/resnet50_bs64/checkpoints/')
    #path_model_res18 = Path('/home/lepersbe/Narval/Barlow_twins_pytorch_lightning/saved_models/Barlow_twins/Barlow/lightning_logs_resnet18/resnet18_bs64/checkpoints/')
    #path_model_res18 = Path('/home/lepersbe/Narval/Barlow_twins_pytorch_lightning/saved_models/Barlow_twins/Barlow/lightning_logs_essai/version_3/checkpoints/')
    #path_model_res18 = Path('/media/ben/Data_linux/code/submeeting_code/saved_models/Barlow_twins/lightning_logs/version_1/checkpoints/')
    #path_model_res18 = Path('/home/lepersbe/Narval/submeeting_2022/code/saved_models/Barlow_twins/lightning_logs/version_0/checkpoints/')
    #path_model_res18 = Path('/home/lepersbe/Narval/submeeting_2022/code/saved_models/Barlow_twins/lightning_logs/version_2/checkpoints/')
    #path_model_res18 = Path('/home/lepersbe/Narval/submeeting_2022/code/saved_models/Barlow_twins/lightning_logs/version_4/checkpoints/')
    #path_model_res18 = Path('/home/lepersbe/Narval/submeeting_2022/code/saved_models/Barlow_twins/lightning_logs/version_12/checkpoints/')
    path_model_res18 = Path('/mnt/narval/narval_BL/contrastive_learning/Narval/saved_models/Barlow_twins/Barlow/lightning_logs/version_7/checkpoints/')
    #str_res50 = 'epoch=7-step=247.ckpt'
    #str_res18 = 'epoch=6-step=216.ckpt'
    #str_res18 = 'epoch=2-step=1127.ckpt'
    #str_res18 = 'epoch=3-step=375.ckpt'
    #str_res18 = 'epoch=16-step=2005.ckpt'
    #str_res18 = 'epoch=696-step=41122.ckpt'
    str_res18 = 'epoch=15-step=495.ckpt'
    #path_model_best = path_model/'epoch=7-step=247.ckpt'
    if arch=="res18":
...
train_ds = datasets_submeeting.train_ds
val_ds = datasets_submeeting.val_ds
...
def train_logreg(bs_train, bs_val, train_feats_data, test_feats_data, model_suffix, max_epochs=EPOCHS_SU, **kwargs):
    ...
    test_loader = data.DataLoader(test_feats_data, batch_size=bs_val, shuffle=False, drop_last=False, pin_memory=True, num_workers=0)
...
def supervised_training():
    logistic_model, results = train_logreg(
        ...
        test_feats_data=val_feats_barlow,
        model_suffix=100,
...
def load_logistic():
    ...
    #path_model = Path('/home/lepersbe/Narval/Barlow_twins_pytorch_lightning/saved_models/Barlow_twins/LogisticRegression/lightning_logs_essai/version_5/checkpoints/')
    #path_model = Path('/media/ben/Data_linux/code/submeeting_code/saved_models/LogisticRegression/')
    #path_model = Path('/home/lepersbe/Narval/submeeting_2022/code/saved_models/LogisticRegression/lightning_logs/version_0/checkpoints/')
    path_model0 = Path('/home/lepersbe/Narval/submeeting_2022/code/saved_models/LogisticRegression/lightning_logs/version_3/checkpoints/')
    path_model = Path('/media/ben/Data_linux/code/Code_testing/contrastive_learning/submeeting_2022/barlow_twins/saved_models/Barlow_twins/lightning_logs/version_3/checkpoints/')
    #path_model_best = path_model/'epoch=0-step=72.ckpt'
    #saved_model = 'epoch=0-step=72.ckpt'
    #saved_model = 'epoch=2-step=218.ckpt'
